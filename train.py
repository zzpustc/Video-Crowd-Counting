...
elif data_mode is 'FDST':
    from datasets.FDST.loading_data import loading_data
    from datasets.FDST.setting import cfg_data 

#------------Prepare Trainer------------
net = cfg.NET
if net in ['MCNN', 'AlexNet', 'VGG', 'VGG_DECODER', 'Res50', 'Res101', 'CSRNet','Res101_SFCN','CascadeCNN']:
...
cc_trainer = Trainer(loading_data('DA'),cfg_data,pwd)
cc_trainer.forward()
