...
class CrowdCounter(nn.Module):
    def __init__(self,gpus,model_name):
        ...
        elif model_name == 'CascadeCNN':
            from .SCC_Model.CascadeCNN import CascadeCNN as net
    ...
    def forward(self, img, gt_map, img_p):                                  
        density_map = self.CCN(img,img_p)                      
        mse_loss_final = self.build_loss(density_map.squeeze(), gt_map.squeeze())  
        self.loss_mse = mse_loss_final
        return density_map
