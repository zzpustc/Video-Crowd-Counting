...
__C.DATASET = 'Mall' # dataset selection: GCC, SHHA, SHHB, UCF50, QNRF, WE, Mall, UCSD,FDST
...
__C.NET = 'CascadeCNN' # net selection: MCNN, AlexNet, VGG, VGG_DECODER, Res50, CSRNet, SANet, CascadeCNN

__C.STN = True # choose STN module

__C.Pre_MODEL_PATH = './best_pre_model/Mall_pre_model.pth'
